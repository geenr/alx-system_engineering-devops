we can use the scp command to copy a file from our localhost to our web servers
the syntax is as follows: scp file_name ubuntu@ip_adrress:/home/ubuntu
Your servers
Name	Username	IP	State	
314889-web-01	ubuntu	54.160.92.231	running	
Tasks
